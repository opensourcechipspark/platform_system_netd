...
#define LOG_TAG "SoftapController_rtl"
...
static const char HOSTAPD_BIN_FILE[]    = "/system/bin/rtl_hostapd";

SoftapController_rtl::SoftapController_rtl() 
    : mPid(0) {}

SoftapController_rtl::~SoftapController_rtl() {
}

int SoftapController_rtl::startSoftap() {
    pid_t pid = 1;
...
int SoftapController_rtl::stopSoftap() {
...
bool SoftapController_rtl::isSoftapStarted() {
 ...
 *  argv[7] - Key
 */
int SoftapController_rtl::setSoftap(int argc, char *argv[]) {
...
void SoftapController_rtl::generatePsk(char *ssid, char *passphrase, char *psk_str) {
 ...
 *	argv[3] - AP or STA
 */
int SoftapController_rtl::fwReloadSoftap(int argc, char *argv[])
{
    int ret, i = 0;
    char *iface;
    char *fwpath;
